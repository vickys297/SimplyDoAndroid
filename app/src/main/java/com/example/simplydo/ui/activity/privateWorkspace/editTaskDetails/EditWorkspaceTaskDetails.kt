package com.example.simplydo.ui.activity.privateWorkspace.editTaskDetails
...
import com.example.simplydo.databinding.EditTaskFragmentBinding
...
internal val TAG_EDIT = EditWorkspaceTaskDetails::class.java.canonicalName

class EditWorkspaceTaskDetails : Fragment(R.layout.edit_task_fragment),
    NewTodoOptionsFragmentsInterface,
    View.OnClickListener {

    private lateinit var groupId: String
    private lateinit var workspaceId: String
    private var arrayListTodoTask: ArrayList<TodoTaskModel> = ArrayList()
    private lateinit var viewModel: EditWorkspaceTaskViewModel
...
/*                    addTodoItemDialog = AddTodoItemDialog.newInstance(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            val taskData =
                it.getSerializable(AppConstant.NAVIGATION_TASK_DATA_KEY) as WorkspaceGroupTaskModel
        ...
        binding.linearLayoutRepeatPeriod.setOnClickListener(this@EditWorkspaceTaskDetails)
        binding.linearLayoutPriority.setOnClickListener(this@EditWorkspaceTaskDetails)
        binding.linearLayoutEventTimeSelector.setOnClickListener(this@EditWorkspaceTaskDetails)
        ...
        binding.btnCreateTodoTask.setOnClickListener {
            ...
            if (validateDetails()) {
                ...
                val newInsertId = viewModel.updateWorkspaceTask(
                    dtId = taskID,
                    title = title,
                    groupId = groupId,
...
//            eventTime = AppFunctions.getPatternByTimeInMilliSec(selectedDueTime, "hh:mm a")
    ...
    private fun setViewModel() {
        ...
        )[EditWorkspaceTaskViewModel::class.java]
        binding.apply {
            this.viewModel = this@EditWorkspaceTaskDetails.viewModel
            lifecycleOwner = this@EditWorkspaceTaskDetails
