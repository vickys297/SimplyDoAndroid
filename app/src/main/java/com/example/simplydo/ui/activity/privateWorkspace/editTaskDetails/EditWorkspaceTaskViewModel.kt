...
internal val TAG = EditWorkspaceTaskViewModel::class.java.canonicalName

class EditWorkspaceTaskViewModel(val appRepository: AppRepository) :
    ViewModel() {
    ...
    fun updateWorkspaceTask(
        ...
        val updateModel = WorkspaceGroupTaskModel(
            dtId = dtId,
            title = title,
            todo = task,
            eventDateTime = eventDate,
        ...
        return appRepository.updateWorkspaceTaskData(updateModel)
    }
